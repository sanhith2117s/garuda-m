      ...
      <header className="fixed top-0 inset-x-0 z-50 px-4 sm:px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between rounded-full border border-slate-900/10 dark:border-white/10 bg-[#f5f2eb]/75 dark:bg-[#0b1117]/75 backdrop-blur-xl px-4 sm:px-6 py-3 shadow-[0_12px_60px_rgba(0,0,0,.08)]">
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex items-center gap-3" aria-label="Back to top">
            ...
            <span className="text-[13px] sm:text-sm font-black tracking-[0.22em] text-[#17365d] dark:text-[#f5f0e7]">GARUDA</span>
          </button>
          <nav className="hidden md:flex items-center gap-6 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#17365d]/75 dark:text-[#f5f0e7]/70">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigate(getPortalPath())} className="hidden sm:flex items-center gap-2 rounded-full bg-[#101820] dark:bg-[#f28c28] px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-white dark:text-[#101820] shadow-[0_8px_30px_rgba(242,140,40,.22)] transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(242,140,40,.38)]">Enter platform <ArrowRight size={13} /></button>
      ...
      <section id="hero" className="relative min-h-[100svh] flex items-center pt-28 pb-16">
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-6 sm:px-10 grid lg:grid-cols-[1.05fr_.95fr] gap-8 items-center">
          <div className="max-w-3xl">
            ...
            <Reveal delay={260}><div className="mt-9 flex flex-wrap gap-3"><button onClick={() => document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' })} className="rounded-full bg-[#101820] dark:bg-[#f28c28] px-6 py-3.5 text-xs font-black uppercase tracking-widest text-white dark:text-[#101820] shadow-[0_10px_35px_rgba(242,140,40,.2)] transition-all hover:-translate-y-1 hover:shadow-[0_16px_45px_rgba(242,140,40,.4)]">Explore the system <ArrowDown className="inline ml-2" size={14} /></button><button onClick={() => navigate(getPortalPath())} className="rounded-full border border-slate-900/15 dark:border-[#f28c28]/60 px-6 py-3.5 text-xs font-black uppercase tracking-widest text-[#17365d] dark:text-[#f5f0e7] transition-all hover:border-[#f28c28] hover:bg-[#f28c28]/10 hover:-translate-y-1">Access platform <ArrowRight className="inline ml-2" size={14} /></button></div></Reveal>
